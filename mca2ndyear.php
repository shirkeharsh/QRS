...
if (isset($_GET['reset_attendance'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Attendance reset to 0'); window.location.href='mca2ndyear.php';</script>";
    } else {
...
$sql = "SELECT * FROM students WHERE school_selected = 'School of MCA' AND year_selected = '2nd year'";
...
<div class="container">
    <h2>School of MCA 2nd Year Students</h2>
...
if (isset($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Student deleted successfully'); window.location.href='mca2ndyear.php';</script>";
    } else {
