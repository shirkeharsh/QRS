...
if (isset($_GET['reset_attendance'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Attendance reset to 0'); window.location.href='mba1styear.php';</script>";
    } else {
...
$sql = "SELECT * FROM students WHERE school_selected = 'School of Management' AND year_selected = '1st year'";
...
<div class="container">
    <h2>School of MBA 1st Year Students</h2>
...
if (isset($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Student deleted successfully'); window.location.href='mba1styear.php';</script>";
    } else {
